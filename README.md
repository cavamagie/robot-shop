...
This repository now includes three Java-based microservices:

1. **Shipping Service** - Handles shipping calculations and logistics
2. **Inventory Service** (NEW) - Manages product inventory and stock levels
3. **Recommendation Service** (NEW) - Provides product recommendations

For detailed information about the Java services, see [JAVA_SERVICES.md](JAVA_SERVICES.md).
